package ru.ifmo.smelik.calculator;
...
import ru.ifmo.smelik.calculator.engine.matchparserrun.MathParserRun;
...
public class CalcActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        equalButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                stringToCalculate = MathParserRun.evaluate(stringToCalculate);
                calculatingText.setText(stringToCalculate);
