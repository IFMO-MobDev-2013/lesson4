    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calcSting.length() != 0 && calcSting.charAt(calcSting.length() - 1) == ')'){
                    calcSting += '*';
                }
                calcSting += 1;
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (calcSting.length() != 0){
                    if (calcSting.charAt(calcSting.length() - 1) == '('){
                        calcSting += 0;
                    }
                    if (calcSting.charAt(calcSting.length() - 1) != '-' && calcSting.charAt(calcSting.length() - 1) != '+' && calcSting.charAt(calcSting.length() - 1) != '*' && calcSting.charAt(calcSting.length() - 1) != '/')
                        calcSting += "+";
        ...
        point.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (t == 0) {
                    if (calcSting.length() == 0) {
                        calcSting += "0";
                    } else if ((calcSting.charAt(calcSting.length() - 1) == '+') || (calcSting.charAt(calcSting.length() - 1) == '-') || (calcSting.charAt(calcSting.length() - 1) == '*') || (calcSting.charAt(calcSting.length() - 1) == '/') || (calcSting.charAt(calcSting.length() - 1) == '(')) {
                        calcSting += "0";
                    }
                    calcSting += ".";
                    t = 1;
        ...
        leftbracked.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (calcSting.length() != 0 && ((calcSting.charAt(calcSting.length() - 1) - '0' >= 0 && calcSting.charAt(calcSting.length() - 1) - '0' <= 9) || calcSting.charAt(calcSting.length() - 1) == ')')){
                    calcSting += '*';
                }
                if (calcSting.length() == 0 || calcSting.charAt(calcSting.length() - 1) == '+' || calcSting.charAt(calcSting.length() - 1) == '-' || calcSting.charAt(calcSting.length() - 1) == '*' || calcSting.charAt(calcSting.length() - 1) == '/' || calcSting.charAt(calcSting.length() - 1) == '(') {
                    calcSting += "(";
                    brkol++;
                }
                disp.setText(calcSting);
